...
def extract_nodes_wide(data: pd.DataFrame, node_type_params: Tuple[hx_utils.NodeTypeParams], edge_type_params: Tuple[hx_utils.EdgeTypeParams]) -> pyg_data.HeteroData:
